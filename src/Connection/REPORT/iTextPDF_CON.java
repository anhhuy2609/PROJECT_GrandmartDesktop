...
public class iTextPDF_CON {
    public void printBill(Bill_DTO dtoBill){
        ...
        try {
            ...
            document.open();
            File filefontTieuDe = new File("D:\\Java\\QuanLyGrandmartForVNUStudent-main\\src\\Connection\\REPORT\\FONTS\\vuArialBold.ttf");
            ...
            File filefontNoiDung = new File("D:\\Java\\QuanLyGrandmartForVNUStudent-main\\src\\Connection\\REPORT\\FONTS\\vuArial.ttf");
